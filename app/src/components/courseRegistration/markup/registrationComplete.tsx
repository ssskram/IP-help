        ...
        <div className="text-center">
            ...
            <div>
              ...
              {this.props.registrationType == "Active" && (
                <h4>
                  ...
                  <br /> and a calendar invite for this event.
                </h4>
              )}
              {this.props.registrationType == "Waitlisted" && (
                <div>
                  <h4>
                    ...
                    <br />
                    you will automatically be moved off of the waitlist and into
                    this course.
                  </h4>
                  <h4>
                    <b>We'll let you know as soon as this happens.</b>
                  </h4>
                  <h4>
                    In the meanwhile, feel free to check back here for your
                    place in line.
                  </h4>
                </div>
              )}
          ...
          {this.props.registrationComplete == "Error" && (
            <div>
              ...
              <h4>
                If this problem persists, please contact the I&P Help Desk
              </h4>
            </div>
          )}
        </div>
