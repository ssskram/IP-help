...
export default class AccessDenied extends React.Component<props, state> {
    ...
    throwLiaisons(department) {
        this.setState({
            department,
            catMood: 'blissful',
            liaisons: this.props.liaisons.filter(l => l.department == department.value)
        })
    }
                    ...
                    <div>
                        <Modal
                            ...
                            <div className='text-center'>
                                ...
                                <h4 style={{ fontFamily: "'Oswald', sans-serif" }}>Only I&P liaisons can order {this.props.itemType}.</h4>
                                <Select
                                ...
                                />
                                {this.state.liaisons &&
                                    <div style={{ marginBottom: '10px', textAlign: 'left', padding: '0px 15px' }}>
                                        <div><u>Liaisons:</u></div>
