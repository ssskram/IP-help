...
export default class Notice extends React.Component<any, any> {
  ...
  public render() {
    ...
    const header = (
      <div>
        <h5 style={{ color: "#fff", cursor: "pointer" }}>
          {" "}
          <img style={imgSize} src={msIcon as string} />
          <b>Trouble with Microsoft?</b>
        </h5>
      </div>
    );
    const contact = (
      ...
      >
        ...
        >
          <b>
            <a href="tel:+1-844-279-8423">1-844-279-8423</a>
          </b>
        </h4>
        <h4 style={{ color: "#fff" }} className="hidden-xs">
          <b>1-844-279-8423</b>
        </h4>
      </ReactCSSTransitionGroup>
    );
    ...
    return (
      <div onClick={() => this.setState({ showContact: !showContact })}>
        <div
          className="hidden-xl hidden-lg hidden-md hidden-sm text-center"
          style={styleSmall}
        >
          <div>{header}</div>
