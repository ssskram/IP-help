      ...
      <div>
        <div className="row">
          <div className="col-sm-6" style={{ padding: "0px 75px" }}>
            ...
            <div className="col-sm-6">
              <a
                className="btn  btn-home text-center"
                target="_blank"
                title="Request a new user account"
                href="https://cityofpittsburgh-my.sharepoint.com/:x:/r/personal/paul_scherrer_pittsburghpa_gov2/_layouts/15/WopiFrame.aspx?guestaccesstoken=Snz9oKYl15kxoHFHQPDs7rtciwH3mrGq7ZYGkIdqAOU%3d&docid=1_1f1cdb0766967490195afb496b2218146&wdFormId=%7B7F3E2D75-4E10-4612-BCE7-CFC4DA40381D%7D&action=formsubmit"
              >
                <img
                  src={email as string}
                  style={imgStyle}
            ...
            <div className="col-sm-6">
              <Link to={"/MobileDevice"} className="btn  btn-home text-center">
                <img
                  src={cellphone as string}
                  style={imgStyle}
                  className="center-block"
                />
                <span className="btn-home-header">Cellphone</span>
                <br />
              </Link>
            </div>
            <div className="clearfix" />
          ...
          <div className="col-sm-6" style={{ padding: "0px 75px" }}>
            ...
            <div className="col-sm-6">
              ...
              >
                <img
                  ...
                  className="center-block"
                />
                <span className="btn-home-header">
                  Notify I&P of international travel
                </span>
              </Link>
            </div>
            <div className="col-sm-6">
            ...
            <div className="col-sm-6">
              <Link
                to={"/EquipmentDisposal"}
                className="btn  btn-home text-center"
              >
                <img
                  src={dispose as string}
                  style={imgStyle}
                  className="center-block"
                />
        ...
        <div className="row">
          <div style={{ fontSize: "3em", marginTop: "80px" }}>
            Something else?
          </div>
