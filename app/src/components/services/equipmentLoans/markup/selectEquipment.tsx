    ...
    return (
      <div className="col-md-4 col-md-offset-4 panel">
        <div className="sectionHeader">
          Equipment
          <span className="glyphicon glyphicon-blackboard pull-right" />
        </div>
        <div className="panel-body">
          <div role="alert" className="alert alert-info text-center">
            If you don't see what you're looking for, it may be out of stock
            during this timeframe. Please contact the Help Desk at 255-2900 for
            further assistance.
          </div>
          <div className="row text-center">
            {checkAvailability("Laptop", availableItems, "Equipment") && (
              <button
                onClick={() => addRemoveItem("Laptop", "Equipment")}
                style={
                  selectedTypes.includes("Laptop")
                    ? style.clicked
                    : style.unclicked
                }
            ...
            {checkAvailability("Surface", availableItems, "Equipment") && (
              <button
                onClick={() => addRemoveItem("Surface", "Equipment")}
                style={
                  selectedTypes.includes("Surface")
                    ? style.clicked
                    : style.unclicked
                }
                className="btn btn-big"
            ...
            {checkAvailability(
              ...
              <button
                onClick={() => addRemoveItem("Portable Projector", "Equipment")}
                style={
                  selectedTypes.includes("Portable Projector")
                    ? style.clicked
                    : style.unclicked
                }
                className="btn btn-big"
            ...
            {checkAvailability(
              ...
              <button
                onClick={() => addRemoveItem("Desktop Speakers", "Equipment")}
                style={
                  selectedTypes.includes("Desktop Speakers")
                    ? style.clicked
                    : style.unclicked
                }
                className="btn btn-big"
