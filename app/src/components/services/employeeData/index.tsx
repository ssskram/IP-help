      ...
      <div className="centered">
        ...
        <div className="row text-center" style={{ marginBottom: "100px" }}>
          <div className="col-md-6 col-md-offset-3">
            <a
              href="https://cityofpittsburgh.sharepoint.com/sites/InnovationandPerformance/IPHelp/Permission_to_View_Email.pdf"
            ...
            >
              <div className="row">
                ...
                <div className="col-md-12">
                  <h3>
                    <span style={fontColor}>Email</span>
                  </h3>
            ...
            <br />
            <a
              href="https://cityofpittsburgh.sharepoint.com/sites/InnovationandPerformance/IPHelp/Permission_to_View_Wireless.pdf"
              className="btn btn-primary btn-big"
            >
              <div className="row">
                <div className="col-md-12">
                ...
                <div className="col-md-12">
                  <h3>
                    <span style={fontColor}>Phone</span>
                  </h3>
                  <span style={fontColor}>
