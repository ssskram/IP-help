    ...
    return (
      <div className="col-md-4 col-md-offset-4 panel">
        <div className="sectionHeader">
          ...
          <span className="glyphicon glyphicon-hdd pull-right" />
        </div>
        <div className="panel-body">
          ...
          {equipmentType == "Mobile Device" && (
            <div
              style={{ padding: "75px 5px 50px 5px" }}
              className="text-center"
            >
              <br />
              <h4>
                Due to passwords and access keys, mobile devices must be
                returned directly to I&P.
              </h4>
              <br />
              <h4>
                <b>
                  Please contact the Help Desk directly to dispose of this
                  device.
                </b>
              </h4>
            </div>
