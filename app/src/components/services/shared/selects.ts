...
export const Departments = [
  ...
  {
    value: "Bureau of Neighborhood Empowerment",
    label: "Bureau of Neighborhood Empowerment",
    name: "Department"
  },
  { value: "Citiparks", label: "Citiparks", name: "Department" },
  {
    value: "Citizen’s Police Review Board",
    label: "Citizen’s Police Review Board",
    name: "Department"
  },
  ...
  {
    value: "Ethics Hearing Board",
    label: "Ethics Hearing Board",
    name: "Department"
  },
  { value: "Finance", label: "Finance", name: "Department" },
  { value: "Fire", label: "Fire", name: "Department" },
  {
    value: "HR & Civil Service",
    label: "HR & Civil Service",
    name: "Department"
  },
  {
  ...
  {
    value: "Pittsburgh Partnership",
    label: "Pittsburgh Partnership",
    name: "Department"
  },
