...
export default class PcInfo extends React.Component<any, any> {
  public render() {
    ...
    const { setState, accessoriesTooltip, softwareTooltip } = this.props;

    return (
      <div className="col-md-4 col-md-offset-4 panel">
        <div className="sectionHeader">
          PC information<span className="glyphicon glyphicon-hdd pull-right" />
        </div>
        <div className="panel-body">
          ...
          {(machineType.value == "Laptop" ||
            machineType.value == "Laptop/Tablet Combo" ||
            machineType.value == "Tablet") && (
            <Select
              value={cellularData}
          ...
          {cellularData.value == "Yes" && (
            <TextArea
              ...
              callback={e =>
                setState({ cellularDataJustification: e.target.value })
              }
              required
            />
          )}
          ...
          {employmentStatus.value === "New" && (
            <Select
              ...
              placeholder="Yes or no"
              onChange={previouslyFunctioning =>
                setState({ previouslyFunctioning })
              }
              multi={false}
              options={SharedSelects.YesNo}
              required
          ...
          {employmentStatus.value === "Existing" && (
            <Select
              ...
              placeholder="Yes or no"
              multi={false}
              onChange={computerFunctioning =>
                setState({ computerFunctioning })
              }
              options={SharedSelects.YesNo}
              required
            />
          ...
          <div className="tooltip-container">
            <a onClick={accessoriesTooltip.bind(this)}>
              View standard accessories
            </a>
          </div>
          <Select
            value={accessories}
          ...
          <div className="tooltip-container">
            <a onClick={softwareTooltip.bind(this)}>
              View standard software applications
            </a>
          </div>
          <TextArea
