        ...
        return <div className="home-container">
            ...
            <div className='row'>
                <div className='col-md-4 text-center'>
                    <a href="https://otrs.city.pittsburgh.pa.us/otrs/customer.pl?Action=CustomerTicketOverview;Subaction=MyTickets" target="_blank" type="button" title="Must be connected to the City network" className="btn btn-big btn-info">
                        <div className='row'>
                ...
                <div className='col-md-4 text-center'>
                    <Link to={'/SelfService'} type="button" className="btn btn-big btn-info">
                        <div className='row'>
                            <div className='col-md-12'>
                ...
                <div className='col-md-4 text-center'>
                    <a href="http://portal.office.com/" target="_blank" type="button" title="Email, OneDrive, etc." className="btn btn-big btn-info">
                        <div className='row'>
                            <div className='col-md-12'>
